...
public class Util {
    ...
    // Base directory for static game asset binaries (.bin files). Can be overridden
    // via
    // -Decho.assets.dir=/path or environment variable ECHO_ASSETS_DIR. Defaults
    // to 'assets'.
    public static final String DEFAULT_ASSETS_DIR = "assets";
    ...
    public static File assetFile(String relativePath) {
        return new File(getAssetsDirectory(), relativePath);
    }
